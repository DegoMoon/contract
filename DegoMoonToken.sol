...
contract DegoMoonToken is Context, IBEP20, Ownable {
    ...
    string private _name = "DegoMoon";
    string private _symbol = "DEGOMOON";
    ...
    address public _degoLPLockedPoolAddress;
    ...
    function setDegoMoonLPPool(address poolAddress) public onlyOwner {
        _degoLPLockedPoolAddress = poolAddress;
    }
